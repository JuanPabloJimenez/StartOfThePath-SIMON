...
public class Simon implements ActionListener, MouseListener {
	...
	public int flashed = 0, ticks, dark, indexPattern;
	...
	public void paint(Graphics2D g) {
		...
		g.drawString("1", WIDTH/2 -150,HEIGHT/2 -100);
		g.drawString("2", WIDTH/2 +80,HEIGHT/2 -100);
		g.drawString("3", WIDTH/2 -150,HEIGHT/2 +150);
		g.drawString("4", WIDTH/2 +80,HEIGHT/2 +150);


		if (gameOver) {
			
					g.drawString("perdiste", WIDTH/2 -150,HEIGHT/2 +17);

		}else {
			g.drawString(indexPattern + "/" + pattern.size(), WIDTH/2 -70,HEIGHT/2 +17);
